...
var content = $('<div class="timepicker">\
		<div v-show class="title" selects="close">x</div>\
			<div class="chose-all">\
				<div class="handle">\
...
timepicker.bindEvent = function () {
	...
	// 选择分钟
		...
		thisTimePicker.title.text('x');
		thisTimePicker.title.attr("selects","close");
	...
	thisTimePicker.hourShow.on('click',function() {
		...
		thisTimePicker.title.text('x');
		thisTimePicker.title.attr("selects","hr");
	});
	...
	thisTimePicker.minuteShow.on('click',function() {
		...
		thisTimePicker.title.text('x');
		thisTimePicker.title.attr("selects","min");
	});
	$(".title").on('click',function(){
		var selects=thisTimePicker.title.attr("selects");
		switch(selects)
		{
			case "close":thisTimePicker.choseAll.hide();
			thisTimePicker.content.remove();
			break;
			case "min":thisTimePicker.choseMinute.hide();
			thisTimePicker.choseAll.show();
			thisTimePicker.title.attr("selects","close");
			break;
			case "hr":thisTimePicker.choseHour.hide();
			thisTimePicker.choseAll.show();
			thisTimePicker.title.attr("selects","close");
			break;
		}
